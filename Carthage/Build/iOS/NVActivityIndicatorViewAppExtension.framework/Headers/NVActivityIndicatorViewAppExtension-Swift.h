...
SWIFT_MODULE_NAMESPACE_PUSH("NVActivityIndicatorViewAppExtension")
@class UIColor;
@class UIFont;
@class NSCoder;
...
/// Stop animating.
- (void)stopAnimating;
- (void)_setTypeName:(NSString * _Nonnull)typeName;
- (NSString * _Nonnull)getTypeName SWIFT_WARN_UNUSED_RESULT;
